...
class NetflixBulkChecker:
    def __init__(self, threads=12):          # ← Increased for faster checking
    ...
    def check_cookie(self, cookie_text, source_name):
        try:
            ...
            r = session.get('https://www.netflix.com/account/membership', timeout=18, allow_redirects=True)  # ← Faster timeout
...
def handle_file(message):
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            checker = NetflixBulkChecker(threads=12)   # ← Faster
...
if __name__ == "__main__":
    print("🚀 Netflix Cookie Checker Bot Started (Fast Mode)")
    bot.remove_webhook()
